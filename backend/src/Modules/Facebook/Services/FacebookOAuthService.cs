...
namespace Modules.Facebook.Services
{
    public class FacebookOAuthService : IFacebookOAuthService
    {
        ...
        private const string RequiredScopes = "pages_show_list,pages_read_engagement,pages_manage_engagement,pages_messaging,pages_manage_metadata,pages_manage_posts,business_management";
