...
يجب توليد ما لا يقل عن 30 سؤالاً توضيحياً مختلفاً باللغة العربية (مثلاً من 30 إلى 35 سؤالاً). حتى لو كان النص الخام قصيراً، قم بابتكار أسئلة حول كافة التفاصيل والسيناريوهات القياسية التي يحتاجها أي بوت خدمة عملاء ذكي (مثل: تفاصيل الشحن والتوصيل للمحافظات، طرق الدفع المتاحة، فروع ومواقع الشركة، أوقات ومواعيد العمل الرسمية، سياسات الاسترجاع والاستبدال، شروط وأحكام الضمان، طريقة التعامل مع الشكاوى والمشاكل التقنية، العروض والخصومات، طريقة التواصل المباشر مع الدعم، وغيرها من التفاصيل الهامة لخدمة العملاء).
