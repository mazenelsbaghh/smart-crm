            ...
            if (settings.IsGroupAppointmentsEnabled)
            {
                try
                {
                    ...
                    var groupsContextText = "معلومات مواعيد المجموعات المتاحة للحجز (Group Appointments):\n" +
                                            ...
                                            "تنبيه هام جداً وصارم بشأن توافر المجموعات: إذا كانت المجموعة مدرجة في 'قائمة المجموعات المتاحة حالياً' بالأسفل، فهذا يعني بشكل قاطع أنها متاحة وبها أماكن شاغرة ومفتوحة للحجز. تجاهل تماماً أي معلومات قديمة أو متعارضة في القاعدة المعرفية أو الملفات المرفقة (مثل التي تدعي أن مجموعات السنتر/سيدي جابر مكتملة تماماً أو تحدد سعة من 12 إلى 21). اعتبر أي مجموعة في القائمة بالأسفل متاحة دائماً واحجز للعميل فيها بشكل طبيعي إذا رغب في ذلك، مع الالتزام التام بعدم ذكر العدد أو السعة أو أي أرقام للعميل إطلاقاً.\n" +
                                            cityInstruction + "\n" +
                                            alreadyBookedNote + "\n\n" +
