...
- [x] T001 Create C# ASP.NET Core Project structure under `backend/`
...
- [x] T002 Create backend Dockerfile under `backend/Dockerfile`
...
- [x] T003 Create Node.js WhatsApp Gateway structure under `whatsapp-gateway/`
...
- [x] T004 Create WhatsApp Gateway Dockerfile under `whatsapp-gateway/Dockerfile`
...
- [x] T005 [P] Update root `docker-compose.yml` to include new services
...
- [x] T006 Create DB Context and Base Entities under `backend/src/Shared/Infrastructure/`
...
- [x] T007 [P] Create RabbitMQ Event Bus under `backend/src/Shared/Queue/`
...
- [x] T008 [P] Setup Tenant Context Provider under `backend/src/Shared/Security/`
...
- [x] T009 [P] [US1] Create integration tests for Auth in `tests/phase_1/test_auth.py`
...
- [x] T010 [P] [US1] Create User & RefreshToken models
...
- [x] T011 [P] [US1] Implement password hashing helper
...
- [x] T012 [US1] Implement JWT service
...
- [x] T013 [US1] Implement AuthController and Endpoints
...
- [x] T014 [P] [US2] Create integration tests for Project Isolation in `tests/phase_1/test_projects.py`
  - Action: Test User A cannot access User B's project or setting records.
  - File: `tests/phase_1/test_projects.py`

### Implementation for User Story 2
- [x] T015 [P] [US2] Create Project & ProjectSettings entities
...
- [x] T016 [US2] Implement ProjectController
...
- [x] T017 [P] [US3] Create connection test in `tests/phase_1/test_whatsapp_gateway.py`
  - Action: Assert starting session, fetching QR, and mock connections.
  - File: `tests/phase_1/test_whatsapp_gateway.py`

### Implementation for User Story 3
- [x] T018 [US3] Implement express server endpoints in `whatsapp-gateway/src/index.js`
  - Action: Setup Express REST API routes for session start, QR fetch, and status check.
  - File: `whatsapp-gateway/src/index.js`

- [x] T019 [US3] Implement Baileys authentication flow in `whatsapp-gateway/src/baileys-manager.js`
...
- [x] T020 [P] [US4] Create webhook and aggregator tests
...
- [x] T023 [US4] Implement Redis Aggregator logic
...
- [x] T024 [P] [US5] Create AI integration tests in `tests/phase_1/test_ai_gemini.py`
  - Action: Mock Gemini API call and assert response logic.
  - File: `tests/phase_1/test_ai_gemini.py`

### Implementation for User Story 5
- [x] T025 [P] [US5] Implement Gemini API Connector
...
- [x] T026 [US5] Implement AI background worker
...
- [x] T027 [US5] Implement Send Message executor
...
- [x] T028 [P] [US6] Create CRM and Follow-up tests in `tests/phase_1/test_crm.py` and `tests/phase_1/test_follow_ups.py`
  - Action: Test metadata updates, follow-up scheduling, and missed flags.
  - File: `tests/phase_1/test_crm.py`

### Implementation for User Story 8
- [x] T029 [P] [US6] Create FollowUp model
  - Action: Define fields for FollowUp.
  - File: `backend/src/Modules/CRM/Domain/FollowUp.cs`

- [x] T030 [US6] Implement CRMController & FollowUp Controller
...
- [x] T031 [US6] Setup Hangfire scheduler check
